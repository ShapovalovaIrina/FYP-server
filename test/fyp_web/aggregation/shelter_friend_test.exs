defmodule ShelterFriendTest do
  ...
  test "Correct parsing" do
    ...
    assert %{
             ...
             birth: "Июл 2012",
             height: "57 см",
             description: "Активный, беззлобный, веселый мальчик. Хорошо уживается с другими собаками по вольеру. Приучен к поводку. Не боится людей, не делает разницы между мужчинами и женщинами. Любит погавкать и похулиганить с незнакомыми людьми. Обожает воду, сам заходит в пруд и плавает."}
           = pet
    %{photos: photos} = pet
